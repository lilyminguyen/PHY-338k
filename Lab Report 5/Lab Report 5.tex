...
\textit{Each lab report, even if it consists if multiple parts, is centered around a central topic.
...
\textit{A description of what you did should be presented with enough detail to allow for your
...
\textit{Please make sure to include all the measurements you are asked to perform in the lab manual.
...
\textit{Quickly summarize your results and their relevance to electronic methods or techniques. The
